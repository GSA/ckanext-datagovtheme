...
class TestDatagovthemeServed(object):
    ...
    def test_datagovtheme_navigation(self, app):
        ...
        assert '<a class="dropdown-toggle" data-toggle="dropdown">Topics<b\n            class="caret"></b></a>' \
               in index_response.unicode_body
        assert '<li><a href="//resources.data.gov">Resources</a></li>' in index_response.unicode_body
        assert '<li><a href="//strategy.data.gov">Strategy</a></li>' in index_response.unicode_body
    ...
    def test_datagovtheme_topics(self, app):
        ...
        assert '<li class="menu-climate">' in index_response.unicode_body
        assert '<li class="menu-energy">' in index_response.unicode_body
        assert '<li class="menu-local-government">' in index_response.unicode_body
        assert '<li class="menu-maritime">' in index_response.unicode_body
    ...
    def test_datagovtheme_organizations(self, app):
        ...
        assert "Search organizations..." in index_response.unicode_body
        assert "What are organizations?" in index_response.unicode_body
